...
config.ui = {
  ssl: true,
  host: 'thawing-hollows-51402.herokuapp.com',
  port: '8080'
}
...
config.CCI = {
    ...
    thresholds: {
        up: 160, // fixed values for overbuy upward trajectory
        down: -10, // fixed value for downward trajectory
...
config.trader = {
  enabled: true,
  key: 'AK6YDSID-MZ1D239P-3DPHBQXB-84F4ICSI',
  secret: '6fd3196d570064b4eafd93e193777c094e50753d12a18f5af3b723c164585c58ac44b4127abf44320da838574acfa2163890234a16511082cf6d2349516ff937',
  username: 'jmschu02@gmail.com' // your username, only required for specific exchanges.
}
...
config.mailer = {
  ...
  port: '8080',       // Set if you don't want to use the default port
}
